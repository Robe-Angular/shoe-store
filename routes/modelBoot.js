...
api.post('/uploadModel/:modelId', [md_auth.ensureAuth, md_role.hasRole(['ROLE_ADMIN']), md_upload] ,ModelBootController.uploadImages);
api.delete('/deleteUploadImage/:modelId/:image', [md_auth.ensureAuth, md_role.hasRole(['ROLE_ADMIN']), md_upload] ,ModelBootController.deleteUpload);
