...
api.get('/getArticlesOrderSendedByUser/:sended/:userId/:page?', [md_auth.ensureAuth, md_role.hasRoleOrUserReqParamsMatch(['ROLE_ADMIN'])] ,ArticleOrderController.getArticleOrdersModelsUsers);
api.get('/getArticlesOrderReceivedByUser/:received/:userId/:page?', [md_auth.ensureAuth, md_role.hasRoleOrUserReqParamsMatch(['ROLE_ADMIN'])] ,ArticleOrderController.getArticleOrdersModelsUsers);
